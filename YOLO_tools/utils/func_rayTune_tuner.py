...
"""
Salvando uma cópia do tuner antigo usado pelo yolo nessa versão, eu modifiquei ele, então caso sofra uma atualização, posso só trocar os arquivos
"""
